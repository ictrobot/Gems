package ictrobot.gems.armor.lapisgem;
...
public class LapisGemBoots extends ItemArmor {

  public LapisGemBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
    super(par1, par2EnumArmorMaterial, par3, par4);
  }

  @SideOnly(Side.CLIENT)
  public void registerIcons(IconRegister par1RegisterIcon) {
    this.itemIcon = par1RegisterIcon.registerIcon("Gems:LapisGem_Boots");
  }
